...
| **Nicht vorhandene Logs** | Logs die auf dem Ziel-Computer nicht existieren (z.B. „Windows Defender" auf einem Server) werden automatisch übersprungen – kein Fehler. |
